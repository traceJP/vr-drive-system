        ...
        protected override void OnUpdate(ProcedureOwner procedureOwner, float elapseSeconds, float realElapseSeconds)
        {
            ...
            switch (m_ChangeToScene)
            {
                case "Menu":
                    ...
                    break;
                case "SubjectOne":
                    ChangeState<ProcedureSubjectOne>(procedureOwner);
                    break;
                case "SubjectTwo":
                    ChangeState<ProcedureSubjectTwo>(procedureOwner);
                    break;
                case "SubjectThree":
                    ChangeState<ProcedureSubjectThree>(procedureOwner);
                    break;
                default:
                    Log.Error("Unknown scene '{0}'.", m_ChangeToScene);
                    break;
            }
        }
